...
// Create a Cognito JWT Verifier to confirm that any JWT we get from a user is valid and something we can trust.
...
// Test by running: curl https://cognito-idp.us-east-1.amazonaws.com/<user-pool-id>/.well-known/jwks.json
jwtVerifier
  .hydrate()
  .then(() => {
...
module.exports.strategy = () =>
  // Create Passport authentication strategy that looks for the Bearer Token
